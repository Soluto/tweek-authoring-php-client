...
/**
 * KeyUpdateModel Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class KeyUpdateModel implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KeyUpdateModel';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['manifest'] === null) {
            $invalid_properties[] = "'manifest' can't be null";
        }
